...
public final class BatchSolver {
    ...
    /**
     * Decimation + Constrained BLS — REMOVED.
     * 30s AR integers don't reliably map to 1Hz segments when cycle slips
     * occur between sample points. Plain solve() at 1Hz gives better stability
     * (7.7mm horiz vs 39mm+ with constrained approach).
     * See BLS_Development_Guide.md for details.
     */
    @Deprecated
